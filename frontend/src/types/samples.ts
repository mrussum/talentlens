import type { SampleScenario } from './candidate';

const SENIOR_PM_NOTES = `Candidate: Priya Ramanathan. Role: Senior Product Manager (B2B SaaS payments).
...
const GRADUATE_ANALYST_NOTES = `Candidate: Tom Beasley. Role: Graduate Strategy Analyst.
...
const SALES_DIRECTOR_NOTES = `Candidate: Marcus Vance. Role: Sales Director (Enterprise, EMEA).
